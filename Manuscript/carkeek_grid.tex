...
We collected samples from 8 points along three parallel transects, separated by 1000m.
...
Sidenote justification for k-means clustering: While variation among sampled ecological is indeed continuous, ecologists often apply categorical groupings to ecological communities.
For example, we may sample along a transect that intersects rainforest and desert.
As our samples become smaller and closer together, we may have increasing difficulty assigning samples to a distinct habitat type.
...
\begin{figure}[h!] % [h!] forces the figure to be placed roughly here
  \centering
    ...
    \caption{Geographic position of collected samples. Lines give 10m isobaths.}
