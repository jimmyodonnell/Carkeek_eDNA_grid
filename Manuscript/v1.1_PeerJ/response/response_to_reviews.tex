...
\begin{response}
  Indeed, our wording did not clearly convey our meaning. Our intent was to indicate the novelty of the experimental design which was intended to capture variability in transport of eDNA. We have made the suggested change.\\
	% TODO: Comment on the novelty of this study in the context of refs: Fonseca et al. 2014, Guardiola et al. 2015 (PLOSONE), Lallias et a. 2015, De Vargas et al. 2015, Hanfling 2016, Guardiola 2016 PeerJ e.g. `while other studies have documented the spatial diversity of meiofauna (Fonseca 2014), '
\end{response}
