...
Of the ______________ taxa ?(for which we recovered data | detected by our methods), we were able to confirm only one which lacks any microscopic and potentially dispersive life stage, the Shiner Surfperch (Embiotocidae).
...
C. aggregata DNA was abundant at sites nearest to shore, (M_____\%+-SD of all sequences,), rare or absent elsewhere (CITE FIG).
...
Such fine-scale variation would be missed by our sampling design; denser sampling in concert with current profiling would ?(_______) the role of ?(ocean movement???) on eDNA dispersal.
