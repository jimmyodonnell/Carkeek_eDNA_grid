...
Detailed bioinformatic methods are provided in the supplement, and scripts used from raw sequencer output onward can be found in the project directory on GitHub.%\href{https://github.com/jimmyodonnell/Carkeek_eDNA_grid}{https://github.com/jimmyodonnell/Carkeek_eDNA_grid}
%----------------------------------------------------------------------------
%METHODS
