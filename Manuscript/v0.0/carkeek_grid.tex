...
We assessed PCR contamination by evaluating the dissimilarity of replicate PCRs of the same DNA sample, and removed one sample for which the Bray-Curtis dissimilarities between itseld and the other replicates exceeded 0.1 (lib_B_tag_GCGCTC).
